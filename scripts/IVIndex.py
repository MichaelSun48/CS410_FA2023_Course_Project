...
class IVIndex:
    def __init__(self, page_ids, notion_secret, rich=False) -> None:
        ...
        self.type_weighting_map = {'heading_1': 3.0, 'heading_2': 2.0, 'heading_3' : 1.5, 'callout': 1.5}
        self.annotation_weigthing_map = {'bold': 1.2, 'italic': 1.1, 'underline': 1.1, 'strikethrough': .5, 'code': 1.0}
        self.inverted_index = {}
        ...
        if isinstance(terms[0], str): # not rich
            ...
            for term, (block_type, annotations) in terms:
                ...
                for annotation in annotations:
                    term_weight *= self.annotation_weigthing_map.get(annotation, 1.0)
